    ...
    class indexedList {
        ...
        autoCreate() {
            ...
            if(dataLen) {
                        ...
                        <% for(let i=0; i < dataLen; i++) { %>
                            <li>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <img src="<%= datas[i].lists[j].avatar %>">
                                        <a>
                                            <p>
                                                <span><%= datas[i].lists[j].name %></span>
                                                <span><%= datas[i].lists[j].nick %></span>
                                            </p>
                                            <p><%= datas[i].lists[j].phone %></p>
                                            <p class="link" onclick="location.href='<%= datas[i].lists[j].chatUrl %>'">聊天</p>
                                        </a>
                                        <div class="del" data-id="<%= datas[i].lists[j].id %>">删除</div>
                                    </dd>
                                    <% } %>
                                </dl>
                            </li>
                ...
                //渲染右侧导航数据，并绑定点击事件
                $(_self.config.elNav).html(parseLabels()).on('mouseover', 'li', function(){
                    //显示当前点击的值，并滚动指定位置
